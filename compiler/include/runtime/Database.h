...
class Database {
   ...
   static std::unique_ptr<Database> loadFromDirSample(std::string directory);
   ...
   virtual void addATable(std::string table_name, std::shared_ptr<arrow::Table> table) = 0;
   virtual std::vector<std::string> getAllTableNames() = 0;
